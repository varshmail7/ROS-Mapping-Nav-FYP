...
(cl:defmethod cl:initialize-instance :after ((m <Map>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Map)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mybot_description-msg:<Map> is deprecated: use mybot_description-msg:Map instead.")))
...
(cl:defmethod position-val ((m <Map>))
...
(cl:defmethod angleOfApproach-val ((m <Map>))
...
(cl:defmethod image-val ((m <Map>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mybot_description-msg:image-val is deprecated.  Use mybot_description-msg:image instead.")
  (image m))

(cl:ensure-generic-function 'cameraInfo-val :lambda-list '(m))
(cl:defmethod cameraInfo-val ((m <Map>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mybot_description-msg:cameraInfo-val is deprecated.  Use mybot_description-msg:cameraInfo instead.")
  (cameraInfo m))
